...
from .views import chatbot_api, chat_page, load_history, list_sessions, chat_summaries, session_summary
...
urlpatterns = [
    ...
    path('summaries/<str:session_id>', session_summary, name='session_summary'),
